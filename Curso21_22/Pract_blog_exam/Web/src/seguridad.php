...
{
    session_destroy();
    die(error_page("Panel de control","<h1>GESTIÓN DE COMENTARIOS</h1><p>Error consumiendo el servicio: ".$url."</p>".$respuesta ));
}
if(isset($obj->error))
{
    session_destroy();
    die(error_page("Panel de control","<h1>GESTIÓN DE COMENTARIOS</h1><p>".$obj->error."</p>"));
}
