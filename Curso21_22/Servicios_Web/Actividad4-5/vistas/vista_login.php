...
if(isset($_POST["btnLogin"]))
{
    ...
    if(!$error_usuario && !$error_clave)//Si se ha tecleado algo en ambos campos
    {
        ...
        {
            session_destroy();
            die(error_page("Login con SW","<h1>Login con SW</h1><p>Error consumiendo el servicio: ".$url."</p>".$respuesta ));
        }
        if(isset($obj->error))
        {
            session_destroy();
            die(error_page("Login con SW","<h1>Login con SW</h1><p>".$obj->error."</p>"));
        }
